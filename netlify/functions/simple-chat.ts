...
- تتبع معايير التعليم ف�� المملكة العربية السعودية ودول الخليج
...
4. اقترح مواضيع محددة مثل الرياضي��ت أو العلوم أو اللغة العربية
...
- إذا أجاب الطالب بشكل صحيح، قل "ممتاز!" أ�� "صحيح!" ثم ابن على إجابته
...
function getMockResponse(message: string): string {
  ...
  if (messageText.includes('مذاكرة') || messageText.includes('دراسة') || messageText.includes('تعلم')) {
    ...
    return 'العلوم مجال واسع ومثير! أي فرع من العلوم تريد أن نتناوله؟ وما المفهوم المحدد الذ�� تحتاج مساعدة فيه؟';
