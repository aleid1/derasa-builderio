        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group p-8 bg-white rounded-3xl shadow-lg border border-neutral-200 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer">
              ...
              <h3 className="text-2xl font-bold text-neutral-900 mb-6 group-hover:text-primary transition-colors duration-300">محادثات ذكية</h3>
              <p className="text-neutral-500 leading-relaxed text-lg">تفاعل مع مدرس الذكاء الاصطناعي للحصول على إجابات فورية ومفصلة لجميع أسئلتك التعليمية</p>
            </div>
            ...
            <div className="group p-8 bg-white rounded-3xl shadow-lg border border-neutral-200 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer">
              ...
              <h3 className="text-2xl font-bold text-neutral-900 mb-6 group-hover:text-secondary transition-colors duration-300">مواد تعليمية</h3>
              <p className="text-neutral-500 leading-relaxed text-lg">اكتشف مجموعة واسعة من المواد التعليمية المخصصة لاحتياجاتك ومستواك الدراسي</p>
            </div>
            ...
            <div className="group p-8 bg-white rounded-3xl shadow-lg border border-neutral-200 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer">
              ...
              <h3 className="text-2xl font-bold text-neutral-900 mb-6 group-hover:text-primary transition-colors duration-300">تعلم سريع</h3>
              <p className="text-neutral-500 leading-relaxed text-lg">تقنيات متقدمة لتسريع عملية التعلم وتحسين الفهم مع نصائح ذكية ومخصصة</p>
            </div>
          </div>
        </div>
      </section>
