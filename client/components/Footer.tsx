        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-neutral-500 mb-8 leading-relaxed text-lg max-w-md">
              منصة تعليمية ذكية تعتمد على الذكاء الاصطناعي لتوفير تجربة تعليمية
              مخصصة وتفاعلية، تساعدك على تحقيق أهدافك بأسلوب سهل وممتع.
            </p>
            <div className="flex space-x-6 space-x-reverse">
              <a
                href="#"
                className="text-neutral-400 hover:text-primary transition-colors duration-200 p-2 hover:bg-primary/10 rounded-lg min-h-[44px] min-w-[44px] flex items-center justify-center"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="/"
                  className="text-neutral-500 hover:text-primary transition-colors duration-200 text-lg min-h-[44px] flex items-center"
                >
                  الرئيسية
                </a>
              </li>
        ...
        <div className="border-t border-neutral-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-8 space-x-reverse mt-6 md:mt-0">
              <a
                href="#"
                className="text-neutral-500 hover:text-primary text-lg transition-colors duration-200 min-h-[44px] flex items-center"
              >
                سياسة الخصوصية
              </a>
              <a
