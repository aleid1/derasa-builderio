    ...
    try {
      ...
      if (false) { // Temporarily disabled fallback check
        ...
        if (messageText.includes('مذاكرة') || messageText.includes('دراسة') || messageText.includes('تعلم')) {
          ...
          contextualResponse = 'أهلاً بك! أنا هنا لمساعدتك في التعلم. يمكنك أن تسألني عن أي موضوع دراسي وسأوجهك خطوة بخطوة للوصول للفهم. ما الموضوع الذي تريد أن نتناوله الي��م؟';
        }
...
- أسلوب طبيعي وودود - مثل معلم ع��دي في المدرسة، مش مثل رجل دين أو واعظ
...
5. **تأكد من فهم الطالب** قبل الانتقال للخطوة التال��ة بعبارات مثل "فاهم إلى هنا؟"
...
- إذا سُئلت عن الشذوذ: "لدي موضوع أفضل! هل تعلم كم هو مذهل علم الرياضيات؟ د��نا نستكشف الأرقام وأسرارها!"
