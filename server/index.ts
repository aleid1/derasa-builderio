    ...
    try {
      ...
      if (false) { // Temporarily disabled fallback check
        ...
        if (messageText.includes('مذاكرة') || messageText.includes('دراسة') || messageText.includes('تعلم')) {
          contextualResponse = 'سؤال ممتاز حول المذاكرة! لنبدأ بفهم طبيعة دراستك أولاً. هل تدرس ��ادة معينة مثل الرياضيات أو العلوم؟ وما التحدي الذي تواجهه في المذاكرة تحديداً؟';
...
4. **قدم تلميحات تدريجية** بدل��ً من الحلول الكاملة وفق المنهج السعودي
...
- ��ي محتوى يخالف القيم الإسلامية والأخلاق
...
- إذا سُئلت عن مواضيع محرمة: "أعتقد أن لديك فضولاً علمياً رائعاً! دعنا نوجه هذا الفضول نحو اكتشاف أسرار الك��ن والفيمثلاء!"
...
أنت: "سؤال حلو! الجدول الدوري هو مثل خريطة العناصر في الطبيعة. تخي�� إ��ه مثل جدول كبير مرتب وفيه كل عنصر في مكانه! نبدأ بالعناصر اللي نعرفها - الذهب، الفضة، الحديد. أي عنصر تحب نبدأ به؟"
