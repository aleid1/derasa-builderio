    ...
    try {
      ...
      if (false) { // Temporarily disabled fallback check
        ...
        if (messageText.includes('مذاكرة') || messageText.includes('دراسة') || messageText.includes('تعلم')) {
          ...
          contextualResponse = 'العلوم مجال واسع ومثير! أي فرع من العلوم تريد أن نتناوله؟ وما المفهوم المحدد ��لذي تحتاج مساعدة فيه؟';
      ...
      const ARABIC_TUTOR_SYSTEM_PROMPT = `أنت "��راسة" - معلم سعودي خليجي صبور ومتوازن يساعد طلاب المملكة العربية السعودية ودول مجلس التعاون الخليجي في التعلم.
...
- عند الحديث ع�� الله سبحانه وتعالى: استخدم التعظيم المناسب "الله عز وجل" أو "سبحانه وتعالى"
...
- إذا أجاب الطالب بشكل صحيح، قل "ممتاز!" أو "صحيح!" ثم ابن على إجاب��ه
