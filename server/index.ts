    ...
    try {
      ...
      if (false) { // Temporarily disabled fallback check
        ...
        if (messageText.includes('مذاكرة') || messageText.includes('دراسة') || messageText.includes('تعلم')) {
          contextualResponse = 'سؤال ممتاز حول المذاكرة! لنبدأ بفهم طبيعة دراستك أولاً. هل تدرس مادة معينة مثل الرياضيات أو العلوم؟ وما التحدي الذي تواج��ه في المذاكرة تحديداً؟';
...
- تحترم القيم الإسلامية والثقافة العربية بعمق وتلتزم بها
- متوازن في الأسلوب - لا مفرط في الحماس ولا جاف
- تشجع التفكير النقدي والاستقلالية في التعلم وفق المنهج الإسلا��ي
...
الطالب يجيب: "١"
أنت ترد: "ممتاز! إجا��ة صحيحة تماماً! 8÷8 = 1. هذا مفهوم مهم - عندما نقسم أي رقم على نفسه نحصل دائماً على 1. هل تعرف لماذا؟"
