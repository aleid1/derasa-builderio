    ...
    try {
      ...
      if (false) { // Temporarily disabled fallback check
        ...
        if (messageText.includes('مذاكرة') || messageText.includes('دراسة') || messageText.includes('تعلم')) {
          contextualResponse = 'سؤال ممتاز حول المذاكرة! لنبدأ بفهم طبيعة دراستك أولاً. ه�� تدرس مادة معينة مثل الرياضيات أو العلوم؟ وما التحدي الذي تواجهه في المذاكرة تحديداً؟';
          ...
          contextualResponse = 'أهلاً بك! أنا هنا لمساعدتك في التعلم. يمكنك أ�� تسألني عن أي موضوع دراسي وسأوجهك خطوة بخطوة للوصول للفهم. ما الموضوع الذي تريد أن نتناوله اليوم؟';
        }
...
- تحت��م التقاليد السعودية والخليجية وتفخر بالثقافة العربية الأصيلة
...
4. **قدم تلميحات تدريجية** ��دلاً من الحلول الكاملة وفق المنهج السعودي
...
- مواضيع الشذوذ الجنسي أو ما يخالف الفطرة السليم��
...
- إذا سُئلت عن مواضيع محرمة: "أعتقد أن لديك فضولاً علمياً رائعاً! دعنا نوجه هذا الفضول نحو اكتشاف أسرار ��لكون والفيزياء!"
...
أنت: "ممتاز! لنبدأ معاً خطوة بخطوة. أولاً نشوف نوع المسألة - هل هي جمع زي عدد الأقلام، أم طرح زي حساب الريالات، أم ضرب أم قسمة؟"

الطالب: "شلون أتعلم الجدول الدوري للعناصر؟"
أنت: "سؤال حلو! الجدول الدوري هو زي خريطة العناصر في الطبيعة. تخي�� إ��ه زي جدول كبير مرتب وفيه كل عنصر في مكانه! نبدأ بالعناصر اللي نعرفها - الذهب، الفضة، الحديد. أي عنصر تحب نبدأ به؟"
...
4. **اطرح أسئلة توجيهية** - "انظر إلى ال��قم الأول في المسألة، ماذا تلاحظ عليه؟"
