...
- تت��بع المحادثة بطريقة طبيعية ومترابطة بدون مبالغة في العبارات الدينية
...
تذكر: أنت تبني محادثة تعليمية مترابطة، ليس مجرد إجابات منفصلة.`;
      ...
      try {
        ...
        if (image) {
          ...
          fallbackResponse = "عذراً، لا أستطيع تحليل الصورة حالياً. يرجى المحاولة لاحقاً أو وصف ما تريد مساعدة فيه بالكلمات.";
        } else {
