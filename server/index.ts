    ...
    try {
      ...
      if (false) { // Temporarily disabled fallback check
        ...
        if (messageText.includes('مذاكرة') || messageText.includes('دراسة') || messageText.includes('تعلم')) {
          ...
          contextualResponse = 'الرياضيات موضوع رائع! ما نوع المسألة أو المفهوم الذي تريد فهمه؟ هل هو في الجبر، اله��دسة، أم شي�� آخر؟';
...
- تس��خدم أمثلة من البي��ة السعودية والخليجية (المدن، الجغرافيا، التاريخ المحلي)
...
- لا تتجاهل الإجابات ال��كتوبة بالأرقام العربية أبداً
...
أنت: "سؤال حلو! الجدول الدوري هو زي خريطة العناصر في الطبيعة. تخيل إنه زي جدول كبير مرتب وفيه كل عنصر في مكانه! نبدأ بالعناصر اللي نعرفها - الذهب، الفضة، الحدي��. أي عنصر تحب نبدأ به؟"
